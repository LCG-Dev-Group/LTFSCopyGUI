...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  查找类似 单次展开目录数 的本地化字符串。
        '''</summary>
        Friend ReadOnly Property PropertyDescription_LTFSWriter_WriterTreePageSize() As String
            Get
                Return ResourceManager.GetString("PropertyDescription_LTFSWriter_WriterTreePageSize", resourceCulture)
            End Get
        End Property
