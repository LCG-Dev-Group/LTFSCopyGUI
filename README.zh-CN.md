...
> [!WARNING]
> LTFSCopyGUI 是一个 source available 的软件，如果你想做什么请先在任意渠道询问贡献者。
>
> LTFSCopyGUI 不是为了**企业级稳定性**设计的，其他的很多功能**非常危险**，若您不具备独立的排障和故障恢复能力，请考虑使用商业备份软件。

[![View - English Document](https://img.shields.io/badge/View-English%20Document-blue?style=for-the-badge)](./README.md "Go to project documentation")
